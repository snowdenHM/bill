!function (root, factory) {
    ...
    var count = 0, d = document, myCreateElement = function (elem, attrs) {
        ...
        var ntfId = "notifier-" + count, container = d.querySelector(".notifier-container"),
    ...
    return createContainer(), {show: show, hide: hide}
});