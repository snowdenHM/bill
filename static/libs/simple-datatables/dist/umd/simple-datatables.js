            ...
            (function (global) {
                (function () {
                            ...
                            !function (t, e, s) {
                                ...
                                switch (e[s._const.action]) {
                                    ...
                                    case s._const.addElement:
                                        ...
                                        n = null === (i = S(t, d)) || void 0 === i ? void 0 : i.node, l = x(e[s._const.element]), n.childNodes || (n.childNodes = []), u >= n.childNodes.length ? n.childNodes.push(l) : n.childNodes.splice(u, 0, l), n.subsets && n.subsets.forEach((function (t) {
                                    ...
                                    case s._const.addTextElement:
                                        ...
                                        }, (n = S(t, d).node).childNodes || (n.childNodes = []), p >= n.childNodes.length ? n.childNodes.push(l) : n.childNodes.splice(p, 0, l), "TEXTAREA" === n.nodeName && (n.value = e[s._const.newValue]), n.subsets && n.subsets.forEach((function (t) {
                    ...
                    var R = {
                        ...
                        return t.prototype.init = function () {
                            ...
                            do {
                                ...
                                0 === (s = this.findNextDiff(t, e, [])).length && (O(t, e) || (this.foundAll ? console.error("Could not find remaining diffs!") : (this.foundAll = !0, N(t), s = this.findNextDiff(t, e, [])))), s.length > 0 && (this.foundAll = !1, this.tracker.add(s), k(t, s, this.options))
                            } while (s.length > 0);
                            ...
                            for (var a, o, r, l, d, c = function (t, e, s) {
                                ...
                                if (!0 === h[_]) if ("#text" === (l = p[_]).nodeName) if ("#text" === m[v].nodeName) {
                                    if (l.data !== m[v].data) {
                                ...
                                } else b.push((new f).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.value, l.data)), h.splice(_, 1), p.splice(_, 1), g = Math.min(h.length, u.length), _ -= 1, v -= 1; else !0 === u[v] ? b.push((new f).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, x(l)).setValue(this.options._const.newValue, x(m[v])).setValue(this.options._const.route, i.concat(_))) : (b.push((new f).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.element, x(l))), h.splice(_, 1), p.splice(_, 1), g = Math.min(h.length, u.length), _ -= 1, v -= 1); else if (!0 === u[v]) "#text" === (l = m[v]).nodeName ? (b.push((new f).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.value, l.data)), h.splice(_, 0, !0), p.splice(_, 0, {
                                    nodeName: "#text",
                                    data: l.data
                    ...
                    const q = (t, e, s, {
                        ...
                        rowRender: g,
                        tabIndex: b
                    }, {noColumnWidths: v, unhideHeader: _, renderHeader: w}, y, M) => {
                        const D = {
                        ...
                        if (D.attributes.class = c(D.attributes.class, r.table), d || h || w) {
                            ...
                            if (d || w) {
                                ...
                                !f.length && !l || _ || (e.attributes = {style: "height: 0px;"}), D.childNodes.unshift(e)
                            }
                            if (h) {
                                const e = {nodeName: "TFOOT", childNodes: [d ? structuredClone(t) : t]};
                                !f.length && !l || _ || (e.attributes = {style: "height: 0px;"}), D.childNodes.push(e)
                            }
                        }
                    ...
                    var U = {exports: {}}, J = z(U.exports = function () {
                    ...
                    }()), W = {exports: {}}, Q = z(W.exports = function () {
                        var t = {
                                LTS: "h:mm:ss A",
                                LT: "h:mm A",
                                L: "MM/DD/YYYY",
                    ...
                    const st = {
                        ...
                        let o = [...Array(i).keys()].map((t => it(t + 1, String(t + 1), n, {active: t === s - 1})));
                    ...
                    exports.DataTable = class {
                        ...
                        constructor(t, e = {}) {
                            ...
                            const i = {...st.diffDomOptions, ...e.diffDomOptions}, n = {...st.labels, ...e.labels},
                            ...
                            this.options = {
                                ...
                                labels: n,
                                classes: a
                            }, this._initialHTML = this.options.destroyable ? s.outerHTML : "", this.options.tabIndex ? this.dom.tabIndex = this.options.tabIndex : this.options.rowNavigation && -1 === this.dom.tabIndex && (this.dom.tabIndex = 0), this._listeners = {onResize: () => this._onResize()}, this._dd = new F(this.options.diffDomOptions || {}), this.initialized = !1, this._events = {}, this._currentPage = 0, this.onFirstPage = !0, this.hasHeadings = !1, this.hasRows = !1, this._searchQueries = [], this.init()
                        }
